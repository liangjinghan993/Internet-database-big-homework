 ...
 *
 * The database connection is specified by [[db]]. Database schema could be initialized by applying databasemigration:
 *
 * ```
 * yii migrate --databasemigrationPath=@yii/i18n/databasemigrations/
 * ```
 *
