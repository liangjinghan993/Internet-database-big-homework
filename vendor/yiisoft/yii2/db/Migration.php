...
/**
 * Migration is the base class for representing a database databasemigration.
 *
 * Migration is designed to be used together with the "yii migrate" command.
 *
 * Each child class of Migration represents an individual database databasemigration which
 * is identified by the child class name.
 *
 * Within each databasemigration, the [[up()]] method should be overridden to contain the logic
 * for "upgrading" the database; while the [[down()]] method for the "downgrading"
 * logic. The "yii migrate" command manages all available databasemigrations in an application.
 *
 ...
 * the whole databasemigration can be reverted in a whole.
 *
 ...
 * applying databasemigrations.
 *
 * For more details and usage information on Migration, see the [guide article on Migration](guide:db-databasemigrations).
 *
...
class Migration extends Component implements MigrationInterface
{
     ...
     * that this databasemigration should work with. Starting from version 2.0.2, this can also be a configuration array
    ...
    /**
     * Initializes the databasemigration.
     ...
     * Child classes may override this method to provide actual databasemigration logic.
     ...
     * Child classes may override this method if the corresponding databasemigrations can be removed.
     * @return bool return a false value to indicate the databasemigration fails
     * and should not proceed further. All other return values mean the databasemigration succeeds.
     */
