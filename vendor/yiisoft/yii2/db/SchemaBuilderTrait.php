 ...
 *
 * These can be used in database databasemigrations to define database schema types using a PHP interface.
 ...
 *
 * For example you may use the following code inside your databasemigration files:
 *
 * ```php
