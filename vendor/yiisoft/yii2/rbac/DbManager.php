 ...
 *
 * The database connection is specified by [[db]]. The database schema could be initialized by applying databasemigration:
 *
 * ```
 * yii migrate --databasemigrationPath=@yii/rbac/databasemigrations/
 * ```
 *
 * If you don't want to use databasemigration and need SQL instead, files for all databases are in databasemigrations directory.
 *
